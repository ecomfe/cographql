...
router.get('/schema-info', async (ctx, next) => {
    ...
    console.log(global.executableSchema);
    try {
        ...
        console.log(123123);
        addMockFunctionsToSchema({schema: global.executableSchema, mocks: {
            String: () => 'Hello',
            Post: () => ({
                // title: 'sdsd'
        ...
        // curProjectInfo.schemaInfo.getCurExecutableSchema(undefined, {
        //     Query: {
        //         posts() {
        //             return posts;
        //         },
        ...
        // addMockFunctionsToSchema({schema: curProjectInfo.schemaInfo.getCurExecutableSchema(), mocks: {
        //     String: () => 'dsdsdsd',
        //     Post: () => ({
        //         // title: 'sdsd'
        //         title: () => 'dddd',
